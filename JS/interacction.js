...
function addUser () {
  ...
  axios.get('https://proyecto-arep-back.herokuapp.com/funcionario/' + emailI)
    .then(function (response) {
      user = response.data
      if (user.length == 0) { 
        axios.post('https://proyecto-arep-back.herokuapp.com/funcionario/create-funcionario', {
          cedula: cedulaI,
          nombre: nombreI,
          apellido: apellidoI,          
          email: emailI,
...
function logearse () {
  ...
  axios.get('https://proyecto-arep-back.herokuapp.com/funcionario/' + correo_login)
    .then(function (response) {
      if (response.data == 0) {
...
function pagos(){  
  axios.get('https://proyecto-arep-back.herokuapp.com/estudiante/all-estudiantes')
    .then(function (response) {      
...
function SearchEstudiante(){
  ...
  axios.get('https://proyecto-arep-back.herokuapp.com/estudiante/'+carne)
    .then(function (response) {      
